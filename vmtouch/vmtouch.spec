...
%install
install -Dm 0755 vmtouch %{buildroot}%{_prefix}/bin/vmtouch
install -Dm 0644 vmtouch.8 %{buildroot}%{_prefix}/share/man/man8/vmtouch.8


%files
%license LICENSE
%doc README.md CHANGES TODO TUNING.md
%{_bindir}/%{name}
%{_mandir}/man8/%{name}.8*
